...
<#-- JavaScript Dependencies -->
    ...
    <#-- Load workflow-form.js depending on presence of taskId in URL query -->
    <#if page.url.args.taskId?? && page.url.args.taskId?has_content>
        <@script src="/com/acibfunin/components/workflow/workflow-form.js" group="workflow"/>
    <#else>
